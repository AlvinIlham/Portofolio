...
import { ArrowLeft, Github, Headphones, X } from "lucide-react";
...
const vrProjects: Project[] = [
  {
    id: "vr-training",
    title: "Professional VR Training",
    description:
      "Immersive virtual reality training platform for industrial and medical professionals.",
    longDescription:
      "A comprehensive VR training platform designed for professional development in industrial and medical fields. The application provides realistic simulations, interactive learning modules, and performance tracking. Built with Unity and optimized for multiple VR headsets.",
    technologies: ["Unity", "C#", "Oculus SDK", "SteamVR", "Blender", "VRTK"],
    features: [
...
export default function VRProjectsPage() {
